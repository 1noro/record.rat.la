...
<html lang="es">
    <head>
        ...
        <script>
            ...
            })(window,document,'script','dataLayer','GTM-5VRTJWC');
        </script>

        <!-- Ojo, hay uno mas en el body -->
    ...
    <body>
        ...
        <div id="content">
            ...
            <noscript>
                <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5VRTJWC" height="0" width="0" style="display:none;visibility:hidden"></iframe>
            </noscript>
