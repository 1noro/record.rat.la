<?php
    ...
    function print_article($directory, $filename) {
        ...
        echo "<p style=\"text-align:right;\"><small><a href=\"index.php?q=" . get_author_data($filename)[1] . "\">" . get_author_data($filename)[0] . "</a> - " . get_date($filename) . " - <a href=\"index.php?q=" . $filename . "\" title=\"Ver este artículo individualmente.\">enlace</a></small></p>";
    }
